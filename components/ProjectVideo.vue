...
<template>
	<Video
		class="!aspect-golden w-full overflow-clip rounded-xl object-cover transition group-hover/card:scale-[1.025] group-hover/card:shadow-2xl group-focus-visible/card:outline group-active/card:scale-[1] group-active/card:shadow-none group-active/card:duration-200 group-data-[project=active]/card:scale-[1] group-data-[project=active]/card:shadow-none group-data-[project=active]/card:duration-200 group-data-[project=active]/card:[view-transition-name:project-hero] group-has/hero:rounded-2xl group-has/hero:[view-transition-name:project-hero] dark:!shadow-none"
		:forcePlay="
