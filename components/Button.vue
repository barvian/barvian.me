...
<template>
	<component
		...
		:class="[
			className,
			size === 'md' ? 'h-12' : 'h-8',
			'group relative isolate flex items-center justify-center gap-3 overflow-clip rounded-full font-medium leading-snug transition *:pointer-events-none hover:scale-110 active:scale-100 active:duration-200',
