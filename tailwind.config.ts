	...
	theme: {
		...
		extend: {
			...
			transitionTimingFunction: {
				...
				DEFAULT: `linear(
					0, 0.005, 0.02 2.1%, 0.081 4.6%, 0.468 15.4%, 0.565, 0.648, 0.72 24.7%,
					0.781 28%, 0.833 31.5%, 0.876 35.2%, 0.912 39.5%, 0.941 44.2%, 0.962 49.6%,
					0.978 55.8%, 0.988 62.8%, 0.995 71.6%, 1
				  )`,
